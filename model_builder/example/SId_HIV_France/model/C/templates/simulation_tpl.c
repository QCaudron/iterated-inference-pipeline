    ...
    for(c=0; c<N_C; c++) {
        for(ac=0; ac<N_AC; ac++) {
            ...
            for(i=0; i<(N_PAR_SV*N_CAC); i++) {
                ...
                f[N_PAR_SV*N_CAC+ (0*N_CAC+ cac)*N_PAR_SV*N_CAC +i] = +(_rj[cac][2])*X[N_PAR_SV*N_CAC+ (0*N_CAC+ cac)*N_PAR_SV*N_CAC +i]+(_rj[cac][0])*X[N_PAR_SV*N_CAC+ (1*N_CAC+ cac)*N_PAR_SV*N_CAC +i];
