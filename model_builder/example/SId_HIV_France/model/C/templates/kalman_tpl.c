...
int step_ode_ekf(double t, const double X[], double f[], void *params)
{
    ...
    for(cac=0;cac<N_CAC;cac++) {
        ...
        _r[cac][3] = (par[ORDER_d][routers[ORDER_d]->map[cac]])+(par[ORDER_k][routers[ORDER_k]->map[cac]]);
    }
    ...
    for (ts=0; ts<obs2ts[o]->n_ts_unique; ts++) {
        ...
        for(n_cac=0; n_cac<obs2ts[o]->n_cac[ts]; n_cac++) {
            ...
            sum_inc +=  + (_r[cac][3]*X[ORDER_I*N_CAC+cac]);
        }
...
void eval_jac(gsl_matrix *Ft, const double *X, struct s_par *p_par, struct s_data *p_data, struct s_calc *p_calc, struct s_group ***compo_groups_drift_par_proc, double t)
{
    ...
    for(cac=0; cac<N_CAC; cac++){
        ...
        _rj[cac][0] = -X[ORDER_S*N_CAC+cac]*par[ORDER_beta][routers[ORDER_beta]->map[cac]]/covar[ORDER_N][nn][cac];
        _rj[cac][1] = -covar[ORDER_mu_d][nn][cac]-(par[ORDER_d][routers[ORDER_d]->map[cac]])-(par[ORDER_k][routers[ORDER_k]->map[cac]])+X[ORDER_S*N_CAC+cac]*par[ORDER_beta][routers[ORDER_beta]->map[cac]]/covar[ORDER_N][nn][cac];
        _rj[cac][2] = X[ORDER_I*N_CAC+cac]*par[ORDER_beta][routers[ORDER_beta]->map[cac]]/covar[ORDER_N][nn][cac];
        _rj[cac][3] = (par[ORDER_d][routers[ORDER_d]->map[cac]])+(par[ORDER_k][routers[ORDER_k]->map[cac]]);
        _rj[cac][4] = 0;
        _rj[cac][5] = -covar[ORDER_mu_d][nn][cac]-X[ORDER_I*N_CAC+cac]*par[ORDER_beta][routers[ORDER_beta]->map[cac]]/covar[ORDER_N][nn][cac];
    }
...
void eval_Q_no_env_sto(gsl_matrix *Q, const double *X, struct s_par *p_par, struct s_data *p_data, struct s_calc *p_calc, struct s_kalman_specific_data *p_kalman_specific_data, double t)
{
    ...
    for (cac=0; cac<N_CAC; cac++) {
        ...
        i = 0 * N_CAC + cac;
        j = 0 * N_CAC + cac;
        term = covar[ORDER_mu_b][nn][cac]*covar[ORDER_N][nn][cac]+covar[ORDER_mu_d][nn][cac]*X[ORDER_S*N_CAC+cac]+X[ORDER_I*N_CAC+cac]*X[ORDER_S*N_CAC+cac]*par[ORDER_beta][routers[ORDER_beta]->map[cac]]/covar[ORDER_N][nn][cac];
        ...
        i = 1 * N_CAC + cac;
        j = 0 * N_CAC + cac;
        term = -X[ORDER_I*N_CAC+cac]*X[ORDER_S*N_CAC+cac]*par[ORDER_beta][routers[ORDER_beta]->map[cac]]/covar[ORDER_N][nn][cac];
        ...
        i = 1 * N_CAC + cac;
        j = 1 * N_CAC + cac;
        term = covar[ORDER_mu_d][nn][cac]*X[ORDER_I*N_CAC+cac]+X[ORDER_I*N_CAC+cac]*((par[ORDER_d][routers[ORDER_d]->map[cac]])+(par[ORDER_k][routers[ORDER_k]->map[cac]]))+X[ORDER_I*N_CAC+cac]*X[ORDER_S*N_CAC+cac]*par[ORDER_beta][routers[ORDER_beta]->map[cac]]/covar[ORDER_N][nn][cac];
    ...
    */
    ...
    for(ts_unique=0; ts_unique < p_obs2ts->n_ts_unique; ts_unique++) {
		...
		term = -X[ORDER_I*N_CAC+cac]*((par[ORDER_d][routers[ORDER_d]->map[cac]])+(par[ORDER_k][routers[ORDER_k]->map[cac]]));
...
void eval_Q_full(gsl_matrix *Q, const double *X, struct s_par *p_par, struct s_data *p_data, struct s_calc *p_calc, struct s_kalman_specific_data *p_kalman_specific_data, double t)
{
    ...
    for (cac=0; cac<N_CAC; cac++) {
        ...
        i = 0 * N_CAC + cac;
        j = 0 * N_CAC + cac;
        term = covar[ORDER_mu_b][nn][cac]*covar[ORDER_N][nn][cac]+covar[ORDER_mu_d][nn][cac]*X[ORDER_S*N_CAC+cac]+pow(X[ORDER_I*N_CAC+cac],2)*pow(X[ORDER_S*N_CAC+cac],2)*pow(par[ORDER_beta][routers[ORDER_beta]->map[cac]],2)*pow(par[ORDER_sto][routers[ORDER_sto]->map[cac]],2)/pow(covar[ORDER_N][nn][cac],2)+X[ORDER_I*N_CAC+cac]*X[ORDER_S*N_CAC+cac]*par[ORDER_beta][routers[ORDER_beta]->map[cac]]/covar[ORDER_N][nn][cac];
        ...
        i = 1 * N_CAC + cac;
        j = 0 * N_CAC + cac;
        term = -pow(X[ORDER_I*N_CAC+cac],2)*pow(X[ORDER_S*N_CAC+cac],2)*pow(par[ORDER_beta][routers[ORDER_beta]->map[cac]],2)*pow(par[ORDER_sto][routers[ORDER_sto]->map[cac]],2)/pow(covar[ORDER_N][nn][cac],2)-X[ORDER_I*N_CAC+cac]*X[ORDER_S*N_CAC+cac]*par[ORDER_beta][routers[ORDER_beta]->map[cac]]/covar[ORDER_N][nn][cac];
        ...
        i = 1 * N_CAC + cac;
        j = 1 * N_CAC + cac;
        term = covar[ORDER_mu_d][nn][cac]*X[ORDER_I*N_CAC+cac]+pow(X[ORDER_I*N_CAC+cac],2)*pow(X[ORDER_S*N_CAC+cac],2)*pow(par[ORDER_beta][routers[ORDER_beta]->map[cac]],2)*pow(par[ORDER_sto][routers[ORDER_sto]->map[cac]],2)/pow(covar[ORDER_N][nn][cac],2)+X[ORDER_I*N_CAC+cac]*((par[ORDER_d][routers[ORDER_d]->map[cac]])+(par[ORDER_k][routers[ORDER_k]->map[cac]]))+X[ORDER_I*N_CAC+cac]*X[ORDER_S*N_CAC+cac]*par[ORDER_beta][routers[ORDER_beta]->map[cac]]/covar[ORDER_N][nn][cac];
...
void eval_Q_no_dem_sto(gsl_matrix *Q, const double *X, struct s_par *p_par, struct s_data *p_data, struct s_calc *p_calc, struct s_kalman_specific_data *p_kalman_specific_data, double t)
{
    ...
    for (cac=0; cac<N_CAC; cac++) {
        ...
        i = 0 * N_CAC + cac;
        j = 0 * N_CAC + cac;
        term = pow(X[ORDER_I*N_CAC+cac],2)*pow(X[ORDER_S*N_CAC+cac],2)*pow(par[ORDER_beta][routers[ORDER_beta]->map[cac]],2)*pow(par[ORDER_sto][routers[ORDER_sto]->map[cac]],2)/pow(covar[ORDER_N][nn][cac],2);
