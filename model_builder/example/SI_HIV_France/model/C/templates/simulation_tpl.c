...
int step_lyap (double t, const double X[], double f[], void *params)
{
    ...
    */
    ...
    for(cac=0; cac<N_CAC; cac++){
        ...
        _rj[cac][1] = -covar[ORDER_mu_d][nn][cac]-(par[ORDER_k][routers[ORDER_k]->map[cac]])+X[ORDER_S*N_CAC+cac]*par[ORDER_beta][routers[ORDER_beta]->map[cac]]/covar[ORDER_N][nn][cac];
