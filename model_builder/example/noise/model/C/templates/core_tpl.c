...

{
    ...
    for (ts=0; ts<obs2ts[o]->n_ts_unique; ts++) {
        ...
        for (n_cac=0; n_cac<obs2ts[o]->n_cac[ts]; n_cac++) {
            ...
            sum_inc +=  + (_r[cac][0]*X[ORDER_I*N_CAC+cac]) + (_r[cac][2]*X[ORDER_I*N_CAC+cac]);
        }
...

{
    ...
    for (ts=0; ts<obs2ts[o]->n_ts_unique; ts++) {
        ...
        for (n_cac=0; n_cac<obs2ts[o]->n_cac[ts]; n_cac++) {
            ...
            sum_inc += ( + (_r[cac][0]*X[ORDER_I*N_CAC+cac]) + (_r[cac][2]*X[ORDER_I*N_CAC+cac]))*dt + sqrt((_r[cac][0]*X[ORDER_I*N_CAC+cac]))*dem_sto__2[cac]+ sqrt((_r[cac][2]*X[ORDER_I*N_CAC+cac]))*dem_sto__4[cac];
        }
...

{
    ...
    for (ts=0; ts<obs2ts[o]->n_ts_unique; ts++) {
        ...
        for (n_cac=0; n_cac<obs2ts[o]->n_cac[ts]; n_cac++) {
            ...
            sum_inc += ( + (_r[cac][0]*X[ORDER_I*N_CAC+cac]) + (_r[cac][2]*X[ORDER_I*N_CAC+cac]))*dt ;
        }
