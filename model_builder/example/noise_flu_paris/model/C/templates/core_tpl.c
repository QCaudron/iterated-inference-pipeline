...
p_calc->prob[ORDER_I][2] = 1.0;
            ...
            p_calc->inc[ORDER_U][cac][0] = gsl_ran_poisson(p_calc->randgsl, (covar[ORDER_mu_b][nn][cac]*covar[ORDER_N][nn][cac]+0.01)*dt);
...

{
    ...
    for(c=0;c<N_C;c++) {
        for(ac=0; ac<N_AC; ac++) {
            ...
            f[0*N_CAC+cac] = X[0*N_CAC+cac] +  ( - (_r[cac][3]*X[ORDER_S*N_CAC+cac]) - (_r[cac][2]*X[ORDER_S*N_CAC+cac]) + (_r[cac][0]))*dt + - sqrt((_r[cac][3]*X[ORDER_S*N_CAC+cac]))*dem_sto__1[cac]- sqrt((_r[cac][2]*X[ORDER_S*N_CAC+cac]))*dem_sto__3[cac]+ sqrt((_r[cac][0]))*dem_sto__0[cac];
            f[1*N_CAC+cac] = X[1*N_CAC+cac] +  ( - (_r[cac][1]*X[ORDER_I*N_CAC+cac]) - (_r[cac][2]*X[ORDER_I*N_CAC+cac]) + (_r[cac][3]*X[ORDER_S*N_CAC+cac]))*dt + - sqrt((_r[cac][1]*X[ORDER_I*N_CAC+cac]))*dem_sto__2[cac]- sqrt((_r[cac][2]*X[ORDER_I*N_CAC+cac]))*dem_sto__4[cac]+ sqrt((_r[cac][3]*X[ORDER_S*N_CAC+cac]))*dem_sto__1[cac];
        }
    }
...

{
    ...
    for(c=0;c<N_C;c++) {
        for(ac=0; ac<N_AC; ac++) {
            ...
            f[0*N_CAC+cac] = X[0*N_CAC+cac] +  ( - (_r[cac][3]*X[ORDER_S*N_CAC+cac]) - (_r[cac][2]*X[ORDER_S*N_CAC+cac]) + (_r[cac][0]))*dt + - sqrt((_r[cac][3]*X[ORDER_S*N_CAC+cac]))*dem_sto__1[cac]- sqrt((_r[cac][2]*X[ORDER_S*N_CAC+cac]))*dem_sto__3[cac]+ sqrt((_r[cac][0]))*dem_sto__0[cac] + - (_r[cac][3]*X[ORDER_S*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__0[cac];
            f[1*N_CAC+cac] = X[1*N_CAC+cac] +  ( - (_r[cac][1]*X[ORDER_I*N_CAC+cac]) - (_r[cac][2]*X[ORDER_I*N_CAC+cac]) + (_r[cac][3]*X[ORDER_S*N_CAC+cac]))*dt + - sqrt((_r[cac][1]*X[ORDER_I*N_CAC+cac]))*dem_sto__2[cac]- sqrt((_r[cac][2]*X[ORDER_I*N_CAC+cac]))*dem_sto__4[cac]+ sqrt((_r[cac][3]*X[ORDER_S*N_CAC+cac]))*dem_sto__1[cac] + + (_r[cac][3]*X[ORDER_S*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__0[cac];
        }
    }
...

{
    ...
    for(c=0;c<N_C;c++) {
        for(ac=0; ac<N_AC; ac++) {
            ...
            f[0*N_CAC+cac] = X[0*N_CAC+cac] +  ( - (_r[cac][3]*X[ORDER_S*N_CAC+cac]) - (_r[cac][2]*X[ORDER_S*N_CAC+cac]) + (_r[cac][0]))*dt + - (_r[cac][3]*X[ORDER_S*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__0[cac];
            f[1*N_CAC+cac] = X[1*N_CAC+cac] +  ( - (_r[cac][1]*X[ORDER_I*N_CAC+cac]) - (_r[cac][2]*X[ORDER_I*N_CAC+cac]) + (_r[cac][3]*X[ORDER_S*N_CAC+cac]))*dt + + (_r[cac][3]*X[ORDER_S*N_CAC+cac])*par[ORDER_sto][routers[ORDER_sto]->map[cac]]*white_noise__0[cac];
        }
    }
...

{
    ...
    for(c=0;c<N_C;c++) {
        for(ac=0; ac<N_AC; ac++) {
            ...
            f[0*N_CAC+cac] = X[0*N_CAC+cac] +  ( - (_r[cac][3]*X[ORDER_S*N_CAC+cac]) - (_r[cac][2]*X[ORDER_S*N_CAC+cac]) + (_r[cac][0]))*dt;
            f[1*N_CAC+cac] = X[1*N_CAC+cac] +  ( - (_r[cac][1]*X[ORDER_I*N_CAC+cac]) - (_r[cac][2]*X[ORDER_I*N_CAC+cac]) + (_r[cac][3]*X[ORDER_S*N_CAC+cac]))*dt;
        }
    }
